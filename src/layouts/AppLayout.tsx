...
export const AppLayout = ({ children }: IAppLayoutProps) => {
	...
	const greenBackground = useFlag("demoApp.greenBackground");
	const showChatBot = useFlag("demoApp.showChatBot");

	const backgroundColor = greenBackground ? "bg-green-900" : "bg-slate-900";
